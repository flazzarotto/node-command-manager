...
var _globalVersion = _classPrivateFieldLooseKey("_globalVersion");

var _default = /*#__PURE__*/function () {
  _createClass(_default, [{
    key: "globalVersion",
    get: function get() {
      return _classPrivateFieldLooseBase(this, _globalVersion)[_globalVersion];
    }
  }]);

  function _default() {
    var globalVersion = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '1.0.0';

    _classCallCheck(this, _default);

    Object.defineProperty(this, _globalVersion, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldLooseBase(this, _globalVersion)[_globalVersion] = globalVersion;
  }
  /**
   * @param mods {Array}
   * @param options {Array}
  ...
  _createClass(_default, [{
    key: "newCommand",
    value: function newCommand(_ref) {
      var _ref$mods = _ref.mods,
          mods = _ref$mods === void 0 ? null : _ref$mods,
          _ref$options = _ref.options,
          options = _ref$options === void 0 ? null : _ref$options,
          _ref$callStack = _ref.callStack,
          callStack = _ref$callStack === void 0 ? null : _ref$callStack,
          _ref$version = _ref.version,
          version = _ref$version === void 0 ? this.globalVersion : _ref$version;
      return new _Command.Command(mods, options, callStack, version);
    }
    /**
    ...
    key: "newPrompt",
    value: function newPrompt(schema, resolve) {
      return new _PromptWrapper.Prompt(schema, resolve);
    }
    /**
